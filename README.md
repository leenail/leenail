...
- **智能桌游硬件**
  - 基于COC（Call of Cthulhu）和DND（Dungeons & Dragons）主题
  - 结合硬件与软件的创新桌游体验
  - 使用嵌入式系统实现交互功能
...
-  桌游硬件设计与开发（ESP32系列狂热爱好者）
-  机器人传感器融合技术探索（我认为机器人的多传感器的高精度融合是未来机器人发展的重要趋势之一）
-  jazz/comic/movie狂热爱好者（欢迎交流捏）
...
## 📫 better call shuhao（1764915977@qq.com）
